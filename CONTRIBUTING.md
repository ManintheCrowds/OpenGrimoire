# Contributing to OpenAtlas

## API and agent contract changes

OpenAtlas follows a **strict public REST contract** for domain entities. Before merging changes that add or modify routes under `src/app/api/`:
...
6. Consider updating [docs/OPENATLAS_SYSTEMS_INVENTORY.md](docs/OPENATLAS_SYSTEMS_INVENTORY.md) if application surfaces or scripts change.
