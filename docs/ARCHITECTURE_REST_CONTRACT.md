...
| Admin security posture | yes (`/api/admin/security-posture`) | — | — | — | Operator session cookie | Runtime security posture snapshot (required env presence + protection toggles) for admin observability panel. |
