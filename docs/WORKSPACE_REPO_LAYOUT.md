...
| **Local folder name** | **Canonical:** `OpenGrimoire` (matches GitHub `ManintheCrowds/OpenGrimoire`). Legacy checkouts may still use `OpenAtlas` on disk until renamed ([OPENGRIMOIRE_NAMING_AND_URLS.md](./engineering/OPENGRIMOIRE_NAMING_AND_URLS.md)). |
