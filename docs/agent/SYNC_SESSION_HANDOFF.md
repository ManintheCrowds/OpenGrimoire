...
**Related:** [INTEGRATION_PATHS.md](./INTEGRATION_PATHS.md) (HTTP parity, intent ledger) · [INTENT_LEDGER_API.md](./INTENT_LEDGER_API.md) · [ELICITATION_EXPORT_CONTRACT.md](./ELICITATION_EXPORT_CONTRACT.md) · [AGENT_INTEGRATION.md](../AGENT_INTEGRATION.md) · [ARCHITECTURE_REST_CONTRACT.md](../ARCHITECTURE_REST_CONTRACT.md) (survey rows) · [ADR_IDEMPOTENCY_AND_RETRY.md](./ADR_IDEMPOTENCY_AND_RETRY.md) (survey POST not idempotent — do not blind-retry) · [engineering/OPERATIONAL_TRADEOFFS.md](../engineering/OPERATIONAL_TRADEOFFS.md) · MiscRepos [SESSION_SNAPSHOT_TEMPLATE.md](../../../MiscRepos/docs/agent/SESSION_SNAPSHOT_TEMPLATE.md) · [HANDOFF_FLOW.md](../../../MiscRepos/.cursor/HANDOFF_FLOW.md)
