...
| Monitoring (OpenGrimoire) | [docs/MONITORING_OPENGRIMOIRE.md](../MONITORING_OPENGRIMOIRE.md) | App/API/process signals; not orchestrator internals. |
...
| Portfolio automation / MCP | MiscRepos `local-proto/docs/`, `.cursor/scripts/` | Out of OpenGrimoire tree; pointer only in monitoring doc. |
