...
**A11y / test ids:** Stable ids in [`vizLayoutIds.ts`](../../src/components/DataVisualization/shared/vizLayoutIds.ts); diagrams expose `data-testid="alluvial-diagram"` / `data-testid="chord-diagram"`; canvas region `data-region="opengrimoire-viz-canvas"`. Cohort header may set **`data-usage-hint`** (see [AGENT_INTEGRATION.md](../AGENT_INTEGRATION.md) § Survey graph JSON).
